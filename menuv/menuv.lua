...
function CreateMenu(info)
    ...
    local item = {
        ...
        Color = {
            ...
            G = U:Ensure(info.G or info.g, 171),
        ...
        ToTable = function(t)
            local tempTable = {
                ...
                color = {
                    ...
                    g = U:Ensure(t.Color.G, 171),
                    b = U:Ensure(t.Color.B, 225)
                },
                items = {}
            }
            ...
            if (tempTable.color.r >= 0) then tempTable.color.r = 0 end
            if (tempTable.color.g <= 171) then tempTable.color.g = 171 end
            if (tempTable.color.g >= 171) then tempTable.color.g = 171 end
        ...
        __newindex = function(t, k, v)
            ...
            if (key == 'Theme' or key == 'theme') then
                ...
                if (theme_value == 'native') then
                    rawset(t.data, 'color', { R = 0, G = 171, B = 255 })
