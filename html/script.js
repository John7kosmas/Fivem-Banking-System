...
$('.close').click(function () {
    ...
    $.post('http://tw-banking/NUIFocusOff', JSON.stringify({}));
});

$('#withdraw').click(function (e) {
    e.preventDefault();
    $.post('http://tw-banking/withdrawl', JSON.stringify({
...
$('#deposit').click(function (e) {
    e.preventDefault();
    $.post('http://tw-banking/deposit', JSON.stringify({
...
$('#transfer').click(function (e) {
    e.preventDefault();
    $.post('http://tw-banking/transfer', JSON.stringify({
        to: $('#idval').val(),
